Drop table Lig_com CASCADE CONSTRAINT;
Drop table Commande CASCADE CONSTRAINT;
Drop table Article CASCADE CONSTRAINT;
...
Create Table Lig_com (
  ...
  CONSTRAINT ci_lig2 FOREIGN KEY (idart) references Article(idart),
  CONSTRAINT ci_cc FOREIGN KEY (numc) references Commande(numc),
